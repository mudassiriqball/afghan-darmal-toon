    ...
    return (
        <div className='_div'>
            ...
            <div className={`sticky-wrapper${isSticky ? ' sticky' : ''}`} ref={ref}>
                <Navbar className='sticky-inner' style={{ justifyContent: 'center', flex: 1 }} variant='light'>
                    <Nav className="justify-content-center" style={{ flex: 1 }}>
                        <Nav.Link href="/home" className='ball' style={{ color: theme.COLORS.MAIN, fontWeight: 'bolder', fontSize: '25px' }}>AFGHAN DARMAL TOON</Nav.Link>
                    </Nav>
                    <Nav className="justify-content-center" style={{ flex: 1 }}>
                        {/* HOME */}
